...
from crud_ws.apps.accounts.serializer import UserSerializer, ChangePasswordSerializer
from crud_ws.apps.utils.error_factory import ErrorFactory, ErrorType
from crud_ws.permissions import IsCreationOrIsAuthenticated, NoPermissionNeeded
...
class UserViewSet(viewsets.ModelViewSet):
    ...
    def lost_password(self, request):
        try:
            ...
            from crud_ws.apps.utils.recovery_password_rest import password_reset
